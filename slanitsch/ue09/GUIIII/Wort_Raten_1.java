...
public class Wort_Raten_1 extends Application {
    ...
    public static double tries_all=0.00;
    public static double versuche_all = 0.00;
    public static double lenghts = 0.00;
    ...
    public void start2(Stage stage) {
        GridPane gridPane = new GridPane();
        Scene scene = new Scene(gridPane, 600, 350); // w, h
        gridPane.setHgap(20);
        gridPane.setVgap(10);
        gridPane.setPadding(new Insets(10));
        stage.setScene(scene);
        ...
        stage.setScene(scene);
        double all_tries = tries_all / lenghts;
        Label spiele =  new Label("Du hast bis jetzt "+ versuche_all + " Spiele gespielt");
        Label prozent = new Label("Im Durchschnitt hast du " + f.format(all_tries*100) + "% aller Buchstaben gebraucht um das Wort zu lösen");
